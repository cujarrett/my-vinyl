# GitHub Copilot Instructions — my-vinyl
...
2. **Sensitive identifiers** — Cloudflare account/tunnel IDs, UUIDs that are runtime secrets
...
| Internal URL | none (public-only app) |
